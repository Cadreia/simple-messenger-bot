...
app.post(`/webhook`, (req, res) => {
    ...
    if (req.body.object == `page`) {
        //  iterate over each entry because there may be multiple if batched
...
function processPostback(event) {
    ...
    if (payload === "Welcome to LadaSchool!") {
        ...
        request({
            ...
            let message = greeting + "Welcome to LadaSchool. What would you like us to help you with?";
